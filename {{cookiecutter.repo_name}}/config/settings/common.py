...
DATABASES = {
    'default': {
        ...
        'NAME': env("POSTGRES_ENV_POSTGRES_USER", default="postgres"),
        'USER': env("POSTGRES_ENV_POSTGRES_USER", default="postgres"),
        'PASSWORD': env("POSTGRES_ENV_POSTGRES_PASSWORD", default=""),
        'HOST': 'postgres',
        'PORT': 5432,
    }
}
